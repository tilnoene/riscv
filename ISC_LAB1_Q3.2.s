...
Ehpar: 
	...
	li a4,0x07	# Definir a cor vermelha
	j DRAW		# Salta para a rotina que desenha o retângulo

Ehimpar:
	la a0,IMPAR	# Armazena o endereço da string IMPAR no registrador a0 
	li a7,104	# Armazena o valor 104 no registrador a7 (serviço para imprimir uma string no Bitmap Display)
	ecall		# Imprime a string IMPAR no Bitmap Display
	li a4,0xD0	# Definir a cor azul
	
DRAW:	
	# Linha Vertical Esquerda
	li a7,47	# Armazena o valor 47 no registrador a7 (serviço para imprimir uma linha no Bitmap Display)
	li a0,60	# XA
	li a1,85	# YA
	li a2,60	# XB
	li a3,135	# YB
	li a5,0		# Frame 0
	ecall		# Imprime a linha vertical esquerda
	...
	li a3,135	# YB
	li a5,0		# Frame 0
	ecall		# Imprime a linha vertical direita
	...
	li a3,85	# YB
	li a5,0		# Frame 0
	ecall		# Imprime a linha horizontal superior
	...
	li a3,135	# YB
	li a5,0		# Frame 0
	ecall		# Imprime a linha horizontal inferior
...
# Foi adicionado a instrução DRAW para desenhar o retângulo em torno das respostas impressas na tela
